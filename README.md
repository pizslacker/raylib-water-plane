...
Modern C demo that renders a dynamic 3D rippling water grid, an Amiga-style horizontal copper-bar background gradient, and a bouncing Amiga Boing Ball above the ripple center.
